...
namespace SDKTemplate
{
    ...
    public static class DisplayHelpers
    {
        ...
        public static GattNativeServiceUuid GetServiceUuid(GattDeviceService service)
        {
            if (IsSigDefinedUuid(service.Uuid))
            {
                GattNativeServiceUuid serviceName;
        ...
        public static GattNativeCharacteristicUuid GetCharacteristicUuid(GattCharacteristic characteristic)
        {
            if (IsSigDefinedUuid(characteristic.Uuid))
            {
                GattNativeCharacteristicUuid characteristicName;
